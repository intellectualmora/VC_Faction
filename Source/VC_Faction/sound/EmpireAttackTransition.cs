...
{
    public class EmpireAttackTransition : MusicTransition
    {
        ...
        private bool IsValidPawn(Pawn pawn)
        {
            ...
            if (lord == null)
                return false;
            if (pawn.Faction.def.defName == FactionDefOf.VC_Empire.defName && !pawn.kindDef.isBoss && !pawn.kindDef.defName.Contains("Raven"))
