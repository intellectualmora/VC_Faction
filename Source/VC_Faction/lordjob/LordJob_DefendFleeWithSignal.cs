...
{
    public class LordJob_DefendFleeWithSignal : LordJob
    {
        ...
        public LordJob_DefendFleeWithSignal()
        {
        ...
        public override StateGraph CreateGraph()
        {
            ...
            graph.AddToil((LordToil)lordToil_PanicFlee);
            ...
            Transition transition5 = new Transition((LordToil)lordToilDefendBase1, (LordToil)lordToil_PanicFlee);
            TaggedString message = "敌人慌张地逃跑了";
            transition5.AddPreAction((TransitionAction)new TransitionAction_Message((string)message, MessageTypeDefOf.ThreatBig));
            transition5.AddTrigger((Trigger)new Trigger_Signal(inSignal));
            transition5.AddSource((LordToil)lordToilDefendBase2);
            transition5.AddSource((LordToil)toilAssaultColony);
