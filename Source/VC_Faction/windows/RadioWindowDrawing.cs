...
{
    public class RadioWindowDrawing : IWindowDrawing
    {
        public GUIStyle EmptyStyle => new GUIStyle();

        public void DoWindowBackground(Rect rect)
        {
            GUI.DrawTexture(rect, ContentFinder<Texture2D>.Get("UI/Windows/Dialog_Radio/background"), ScaleMode.StretchToFill, alphaBlend: true);
        }
